    ...
    value: function save(saveFrom) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        (0, _mkdirp2.default)(_path2.default.dirname(_this2.cacheTo), function (err) {
          ...
          var cName = typeof _this2.cacheTo === 'string' && _this2.cacheTo.indexOf('.tar.gz') === -1 ? _this2.cacheTo + '.tar.gz' : _this2.cacheTo;
          _tarPack2.default.pack(saveFrom, { ignoreFiles: [] }).pipe(_fs2.default.createWriteStream(cName)).on('close', function (err) {
            return err ? reject(err) : resolve();
          });
        });
      });
