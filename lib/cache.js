  ...
  _createClass(_class, [{
    ...
    value: function install(installTo) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        _fs2.default.createReadStream(_this.packageName).pipe(_tarPack2.default.unpack(installTo, function (err) {
    ...
    value: function save(saveFrom) {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        (0, _mkdirp2.default)(_path2.default.dirname(_this2.cacheTo), function (err) {
          ...
          _tarPack2.default.pack(saveFrom, { ignoreFiles: [] }).pipe(_fs2.default.createWriteStream(_this2.packageName)).on('close', function (err) {
            return err ? reject(err) : resolve();
          });
        });
      });
    ...
    key: 'exists',
    get: function get() {
      return _fs2.default.existsSync(this.packageName);
    }
  }, {
    key: 'packageName',
    get: function get() {
