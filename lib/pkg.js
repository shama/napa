  ...
  _createClass(_class, [{
      ...
      if (this.isInstalled) {
        ...
        return (function () {
          switch (_this.installMethod) {
            ...
            case 'download':
              return archive.install(_this.url, _this.installTo);
            case 'git':
              return git.clone(_this.installTo, _this.url).then(function () {
                return git.enableShallowCloneBranches(_this.installTo);
              }).then(function () {
                return git.fetch(_this.installTo, _this.ref);
              }).then(function () {
                return git.checkout(_this.installTo, _this.ref);
              });
          }
        })().then(function () {
          ...
          return _this.useCache && _this.isInstalled ? _this.cache.save(_this.installTo) : _bluebird2.default.resolve();
        }).catch(function (err) {
    ...
    value: function update() {
      ...
      return (function () {
        ...
        return _this2.log.info('napa', _this2.name + '@' + _this2.ref + ' ' + _path2.default.relative(process.cwd(), _this2.installTo));
      }).then(function () {
    ...
    value: function saveToNodeModules() {
      var npm = (0, _child_process.spawn)('npm', ['install', '--save-optional', 'file:' + this.installTo]);
