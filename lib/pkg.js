...
var _class = (function () {
  function _class(location, name) {
    ...
    if (this.useCache) {
      this.cache = new _cache2.default(this.location, opts);
    }
  ...
  _createClass(_class, [{
    ...
    value: function install(done) {
      ...
      _npmlog2.default.info('napa', 'INSTALLING: ' + this.location);
      if (this.isInstalled) {
        ...
        return (function () {
          switch (_this.installMethod) {
            ...
            case 'download':
              return archive.install(_this.location.slice(_this.location.lastIndexOf('/') + 1), _this.location, _this.cwd, _this.installTo, _this.useCache, _this.cache.cacheTo.slice(0, _this.cache.cacheTo.lastIndexOf('/')));
            case 'git':
              return git.clone(_this.installTo, _this.location, _this.ref).then(function () {
    ...
    value: function update() {
      ...
      return (function () {
        switch (_this2.installMethod) {
          ...
          case 'download':
            return archive.install(_this2.location, _this2.installTo);
          case 'git':
        ...
        if (_this2.useCache && _this2.isInstalled && _this2.installMethod !== 'download') {
          return _this2.cache.save(_this2.installTo).then(function () {
            return _bluebird2.default.resolve(_this2);
          });
        } else {
          return _bluebird2.default.resolve(_this2);
        }
