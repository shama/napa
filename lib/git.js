...
function checkout(installTo, ref) {
  if (ref !== 'master') {
    _npmlog2.default.info('napa', 'checking out branch ' + ref);
    return (0, _cl2.default)('git', ['checkout', 'origin/' + ref], { cwd: installTo });
  }
...
function clone(installTo, url) {
  ...
  return (0, _cl2.default)('git', ['clone', '--depth', '1', '-q', url.replace('git+', ''), installTo]);
}
