...
test('args', function (t) {
  t.plan(5)
  t.deepEqual(cli.parseArgs('user/repo'), ['git://github.com/user/repo', 'repo', ''])
  t.deepEqual(cli.parseArgs('https://github.com/user/repo:testing'), ['https://github.com/user/repo', 'testing', ''])
  t.deepEqual(cli.parseArgs('git://github.com/user/repo2'), ['git://github.com/user/repo2', 'repo2', ''])
  // when developing on windows, this returns zip, linux is tar.gz
  t.deepEqual(cli.parseArgs('angular/angular.js#v1.2.3:angular'), ['https://github.com/angular/angular.js/archive/v1.2.3.' + ((process.platform === 'win32') ? 'zip' : 'tar.gz'), 'angular', 'v1.2.3'])
  t.deepEqual(cli.parseArgs('https://github.com/angular/angular.js/archive/master.zip:angular'), ['https://github.com/angular/angular.js/archive/master.zip', 'angular', ''])
})
//
